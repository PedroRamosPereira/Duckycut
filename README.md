...
5. Ajuste as configurações manuais na tela seguinte.
6. Clique `Apply Cuts`; nesse momento o FFmpeg detecta silêncios com a configuração atual e, em seguida, aplica os cortes in-place.
